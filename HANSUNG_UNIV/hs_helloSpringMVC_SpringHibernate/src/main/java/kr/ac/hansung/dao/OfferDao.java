...
// JdbcTemplate -> sessionFactory

@Repository
@Transactional  //각각 Transaction 넣는다. => AOP 기능을 이용해서 들어감. 
public class OfferDao {
    ...
    public List<Offer> getOffers() {
    	...
    	Query <Offer> query = session.createQuery(hql, Offer.class);  //org.hibernate.query.Query 넣기
